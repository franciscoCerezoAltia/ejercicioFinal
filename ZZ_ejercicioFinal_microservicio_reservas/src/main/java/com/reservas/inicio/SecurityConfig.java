...
public class SecurityConfig {	
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf().disable()
			...
			.antMatchers(HttpMethod.POST,"/reservas").hasRole("Admin")
			.antMatchers(HttpMethod.GET,"/reservas/**").authenticated()
			.antMatchers(HttpMethod.PUT,"/reservas").hasRole("Admin")
			.antMatchers(HttpMethod.PUT,"/reservas/**").hasAnyRole("Operador","Admin")
			.antMatchers(HttpMethod.DELETE,"/reservas/**").hasAnyRole("Operador","Admin")
			.and()
			.httpBasic();
